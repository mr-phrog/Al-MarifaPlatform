...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = '<span data-ar="تم حذف التعليق بالفعل!" data-en="Comment already deleted!"></span>';
   }
...
<head>
   ...
   <title data-ar="عرض المحتوى" data-en="view content"></title>
...
<section class="view-content">
   ...
   <div class="container">
      ...
      <div class="flex">
         <div><i class="fas fa-heart" data-ar=" اعجابات" data-en=" Likes"></i><span><?= $total_likes; ?></span></div>
         <div><i class="fas fa-comment" data-ar=" تعليقات" data-en=" Comments"></i><span><?= $total_comments; ?></span></div>
      </div>
   ...
   <?php
      ...
      echo '<p class="empty" data-ar="لا يوجد أي محتوى مضاف حتى الآن!" data-en="no contents added yet!"> <a href="add_content.php" class="btn" style="margin-top: 1.5rem;" data-ar="إضافة فيديوهات" data-en="add videos"> </a></p>';
   }
...
<section class="comments">
   ...
   <h1 class="heading" data-ar="تعليقات المستخدمين" data-en="user comments"></h1>
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" data-ar="حذف التعليق" data-en="delete comment" class="inline-delete-btn" onclick="return confirmAction (event,'delete_comment');">delete comment</button>
         </form>
      </div>
      <?php
      }
      }else{
         echo '<p class="empty" data-ar="لا توجد تعليقات حتى الآن!" data-en="no comments added yet!"></p>';
      }
      ?>
      </div>
