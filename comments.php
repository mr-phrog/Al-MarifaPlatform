...
<head>
   ...
   <title data-ar="التعليقات" data-en="user comments"></title>
...
<section class="edit-comment">
   <h1 class="heading" data-ar="تعديل التعليق" data-en="edit comment"></h1>
   <form action="" method="post">
      <input type="hidden" name="update_id" value="<?= $fetch_edit_comment['id']; ?>">
      <textarea name="update_box" class="box" maxlength="1000" required data-ar="من فضلك أدخل تعليقك" data-en="please enter your comment" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
         <a href="comments.php" class="inline-option-btn"data-ar="الغاء التعديل" data-en="cancel edit"></a>
         <input type="submit" value="update now" name="update_now" data-ar="تحديث الآن" data-en="update now" class="inline-btn">
      </div>
   </form>
</section>
<?php
...
<section class="comments">
   ...
   <h1 class="heading" data-ar="تعليقاتك" data-en= "your comments"></h1>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         <div class="content"><span><?= $fetch_comment['date']; ?></span><p> - <?= $fetch_content['title']; ?> - </p><a data-ar="عرض المحتوى" data-en="view content" href="watch_video.php?get_id=<?= $fetch_content['id']; ?>"></a></div>
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn" data-ar="تعديل التعليق" data-en="edit comment"></button>
      ...
      <?php
         ...
         echo '<p class="empty" data-ar= "لم يتم إضافة أي تعليق!" data-en="no comments added yet!"></p>';
      }
      ?>
      </div>
